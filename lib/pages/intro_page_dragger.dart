 ...
 class IntroPageDragger extends StatefulWidget {
   ...
   @override
   _IntroPageDraggerState createState() => new _IntroPageDraggerState();
 }

 class _IntroPageDraggerState extends State < IntroPageDragger > {
 ...
 class AnimatedPageDragger {
   static
   const PERCENT_PER_MILLISECOND = 0.005;
