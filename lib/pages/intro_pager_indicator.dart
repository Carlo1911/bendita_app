...
class IntroPagerIndicator extends StatelessWidget {

  final IntroPagerIndicatorViewModel viewModel;
  ...
  Widget build(BuildContext context) {
    ...
    for (var i = 0; i < viewModel.pages.length; ++i) {
      ...
      bubbles.add(
        new IntroPageBubble(
          viewModel: new IntroPageBubbleViewModel(
            page.iconAssetPath,
            page.color,
            isHollow,
            percentActive,
...
class IntroPagerIndicatorViewModel {
  final List < IntroPageViewModel > pages;
  final int activeIndex;
  final SlideDirection slideDirection;
  final double slidePercent;

  IntroPagerIndicatorViewModel(
    this.pages,
    this.activeIndex,
    this.slideDirection,
    this.slidePercent,
...
class IntroPageBubble extends StatelessWidget {

  final IntroPageBubbleViewModel viewModel;
            ...
            decoration: new BoxDecoration(
              ...
              color: viewModel.isHollow ? const Color(0x88FFFFFF).withAlpha((0x88 * viewModel.activePercent).round()) : const Color(0x88FFFFFF),
                border: new Border.all(
                  ...
                  const Color(0x88FFFFFF).withAlpha((0x88 * (1.0-viewModel.activePercent)).round()) : Colors.transparent,
                )
            ),
            child: new Opacity(
...
class IntroPageBubbleViewModel {
  final String iconAssetPath;
  final Color color;
  final bool isHollow;
  final double activePercent;

  IntroPageBubbleViewModel(
    this.iconAssetPath,
    this.color,
    this.isHollow,
    this.activePercent,
